  ...
  return (
    <div className="relative h-screen w-full bg-black overflow-hidden flex flex-col items-center justify-center text-white">
      ...
      <div className="z-10 text-center space-y-8 max-w-4xl px-4">
        ...
        >
            {/* The status box is now an interactive BentoCard */}
            <BentoCard 
              className="bg-military-900/50 backdrop-blur border border-military-700 p-8 rounded-xl max-w-lg mx-auto"
              enableTilt={true}
            ...
            >
              ...
              <button 
                onClick={onEnter}
                className="group w-full bg-military-red hover:bg-red-700 text-white border border-military-red transition-all duration-300 py-4 px-8 rounded-lg font-bold tracking-widest flex items-center justify-center gap-2 shadow-lg shadow-military-red/20"
              >
                INITIALIZE SEQUENCE
